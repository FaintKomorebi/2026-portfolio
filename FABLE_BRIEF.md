...
2026-portfolio v2 /
  ...
  resources/          — images, videos, resume PDF
  FABLE_BRIEF.md      — this file
  CLAUDE.md           — project instructions (partially stale — describes v1 design system)
```

**Repo:** https://github.com/FaintKomorebi/2026-portfolio
**Hosting:** GitHub Pages — commit and push after every approved change (`git commit && git push origin main`)
